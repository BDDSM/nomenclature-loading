...
Функция СоздатьОбновитьНоменклатуру(СтрокаДанных)	
	...
	Если ЗаписаЭлемент Тогда
		...
		НачатьТранзакцию();
			...
			ЗаполнитьРеквизитСправочника(ОбъектЕдиница, "Наименование", СтрокаДанных, СоздатьНовыйЭлемент, ЗаписаЭлемент);
...
Процедура ЗаполнитьРеквизитСправочника(ОбъектСправочник, ИмяРеквизита, СтрокаДанных, СоздатьЭлемент, ЗаписаЭлемент)
	...
	НайденнаяКолонка = СтрокаДанных.Колонки.Найти(ИмяРеквизита);
	...
	Если ЗначениеЗаполнено(Значение) Тогда 
		...
		Если ИмяРеквизита = "НаименованиеПолное" Тогда
			
			НайденнаяКолонка = СтрокаДанных.Колонки.Найти("Наименование");
			Если НайденнаяКолонка <> Неопределено Тогда	
		...
		ИначеЕсли ИмяРеквизита = "БазоваяЕдиницаИзмерения"
			...
			Значение = Справочники.КлассификаторЕдиницИзмерения.НайтиПоКоду(); //???
