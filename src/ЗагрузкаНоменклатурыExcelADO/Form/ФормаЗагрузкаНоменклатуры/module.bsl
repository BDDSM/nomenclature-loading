...
Процедура СоответствиеКолонокПриАктивизацииСтроки(Элемент)
	...
	Если Элемент.ТекущаяСтрока.НомерКолонки > 0  Тогда
		мТекущаяОбласть = ЭлементыФормы.ПредварительныйПросмотр.Область(1, Элемент.ТекущаяСтрока.НомерКолонки, ЭлементыФормы.ПредварительныйПросмотр.ВысотаТаблицы,Элемент.ТекущаяСтрока.НомерКолонки);
